...
export function UiPageModalLayout({ close, children }: Props) {
  return (
    ...
    >
      ...
      <div
        className="bg-white rounded-lg shadow-lg p-6 gap-6 overflow-auto flex flex-col 1024:max-w-[90vw] max-h-[80vh] 1024:max-h-[100vh] 1024:rounded-none w-full 1024:w-auto"
